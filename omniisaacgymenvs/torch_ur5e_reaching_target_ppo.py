...
env = load_omniverse_isaacgym_env(task_name="BasicReachingTarget")
...
models["policy"] = BasicShared(env.observation_space,
                          env.action_space,
                          device,)
...
cfg["experiment"]["directory"] = "./runs/torch/Basic_Reaching_Target"
...
# path = '/home/bak/.local/share/ov/pkg/isaac_sim-2023.1.0-hotfix.1/OmniIsaacGymEnvs/omniisaacgymenvs/runs/torch/Reaching_Target_PCD/240323_221527_Reaching_Target_Simple_Shared/checkpoints/agent_29600.pt'
# agent.load(path)
